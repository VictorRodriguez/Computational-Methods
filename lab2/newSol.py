    ...
    for i in regex:
        ...
        # a or b
            ...
            if(top(stack)=="+"):
                operator=stack.pop()
                left=stack.pop()
                right=ExpressionNode(i)
                stack.append(ExpressionNode(operator,left,right))
            elif(top(stack)in symbols or type(top(stack))==ExpressionNode):
                left=ExpressionNode(stack.pop())
                right=ExpressionNode(i)
                stack.append(ExpressionNode(".",left,right))
            else:
